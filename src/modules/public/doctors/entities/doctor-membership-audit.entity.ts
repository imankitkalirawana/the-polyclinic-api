...
export enum DoctorMembershipAuditAction {
  MEMBERSHIP_CREATED = 'MEMBERSHIP_CREATED',
  MEMBERSHIP_RESTORED = 'MEMBERSHIP_RESTORED',
  MEMBERSHIP_REVOKED = 'MEMBERSHIP_REVOKED',
}

@Entity('doctor_membership_audit_logs', { schema: 'public' })
@Index(['doctorId', 'tenantSlug', 'createdAt'])
export class DoctorMembershipAuditLog {
  ...
  @Column({ type: 'enum', enum: DoctorMembershipAuditAction })
